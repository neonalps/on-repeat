class MusicProviderAlbumDao {
    ...
    public static fromDaoInterface(daoInterface: MusicProviderAlbumDaoInterface | null): MusicProviderAlbumDao | null {
        ...
        return this.Builder
            ...
            .withAlbumId(daoInterface.albumId)
            .withMusicProviderAlbumId(daoInterface.musicProviderAlbumId)
            .withMusicProviderAlbumUri(daoInterface.musicProviderAlbumUri)
