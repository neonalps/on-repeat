class MusicProviderTrackDao {
    ...
    public static fromDaoInterface(daoInterface: MusicProviderTrackDaoInterface | null): MusicProviderTrackDao | null {
        ...
        return this.Builder
            ...
            .withTrackId(daoInterface.trackId)
            .withMusicProviderTrackId(daoInterface.musicProviderTrackId)
            .withMusicProviderTrackUri(daoInterface.musicProviderTrackUri)
